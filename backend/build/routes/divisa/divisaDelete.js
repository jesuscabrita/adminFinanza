...
exports.divisa_delete = void 0;
const http_errors_1 = require("http-errors");
const mongoose_1 = require("mongoose");
const is_empty_1 = require("../../util/is_empty");
const divisa_model_1 = require("../../model/divisa.model");
const divisa_delete = (app) => __awaiter(void 0, void 0, void 0, function* () {
    app.delete("/:divisa_id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.divisa_delete = divisa_delete;
